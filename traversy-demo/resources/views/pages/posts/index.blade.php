...
@section('content')
    <h1 class="text-5xl text-center p-4 border-b-2 border-double mb-6">Blog Posts</h1>
    @if(count($posts) > 0)
        <div class="flex gap-4">
            @foreach ($posts as $post)
                <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Written on {{ $post->created_at }}</p>
